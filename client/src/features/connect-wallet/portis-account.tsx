...
import WalletImg from 'assets/icons/portis.png'
import { useSnackbar } from 'shared/hooks'
import { SnackbarVariant } from 'shared/enums'

type PortisAccountProps = {
  onClose: () => void
}

export const PortisAccount: FC<PortisAccountProps> = ({ onClose }) => {
  ...
  return (
    <Button
      ...
      onClick={connect}
    >
      <p className="text-lg text-black font-medium leading-6">Portis</p>
      <div className="flex flex-row justify-center items-center bg-wallet-500 rounded-full w-14 h-14">
        <img src={WalletImg} alt="Wallet Portis" />
      </div>
    </Button>
  )
}
